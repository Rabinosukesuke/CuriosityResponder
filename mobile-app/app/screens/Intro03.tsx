...
export const Intro03 = ({
  ...
  return (
    <SafeAreaView style={{ backgroundColor: theme.colors.card, flex: 1 }}>
      ...
      >
        <TouchableOpacity onPress={() => navigation.replace("Intro02")}>
      ...
      <View style={{ padding: 24 }}>
        ...
        >
          <ScreenIndicators count={8} activeIndex={2} />
        </Animated.View>
        ...
        >
          <PrimaryButton
            label="Next"
            onPress={() => navigation.replace("Intro04")}
          />
        </Animated.View>
      </View>
    </SafeAreaView>
